...
public class PerformanceMetrics {
  ...
  private final AtomicInteger methodsCollectedCount = new AtomicInteger(0);
  ...
  public void recordMethodsCollected(int count) {
    methodsCollectedCount.addAndGet(count);
  }
